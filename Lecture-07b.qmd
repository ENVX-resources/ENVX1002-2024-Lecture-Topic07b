...
- If we have **categorical data** and we want to determine whether the observed frequencies differ from the expected frequencies, we can use a **chi-squared test**.
- We're asking whether the observed incidence of outcomes for each level of the
predictor variable could have happened by chance.
